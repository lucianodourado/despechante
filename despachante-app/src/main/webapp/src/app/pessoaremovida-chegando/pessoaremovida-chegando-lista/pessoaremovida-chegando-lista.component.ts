...
@Component({
  selector: 'app-pessoaremovida-chegando-lista',
  templateUrl: './pessoaremovida-chegando-lista.component.html',
  styleUrls: ['./pessoaremovida-chegando-lista.component.css']
})
export class PessoaremovidaChegandoListaComponent implements OnInit {
  ...
  displayedColumns = ['matricula', 'cpf', 'nome', 'ramo', 'acao'];
  ...
  preencheGrid() {
    this.mpmHttp.get(environment.apiPath + `/internal/v1/pessoa/chegando/?`,
      new HttpParams()
        // paginação
